...
import { validationSchema as authLoginValidation } from '../controllers/authLogin.validation';
import { validationSchema as authSignupValidation } from '../controllers/authSignup.validation';
